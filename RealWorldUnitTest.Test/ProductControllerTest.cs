...
namespace RealWorldUnitTest.Test
{
    public class ProductControllerTest
    {
        ...
        public async void CreatePOST_ValidModelState_CreateMethodExecute()
        {
            ...
            _mockRepo.Setup(repo => repo.Create(It.IsAny<Product>())).Callback<Product>(r => newProduct = r);
            var result = await _controller.Create(products.First());
        ...
        {
            var result = _controller.Edit(2, products.First(r => r.Id == productId));
        ...
        {
            _controller.ModelState.AddModelError("Name", " ");
            var result = _controller.Edit(productId, products.First(r => r.Id == productId));
            var viewResult = Assert.IsType<ViewResult>(result);
        ...
        {
            var product = products.First(r => r.Id == productId);
        ...
        [Theory]
        [InlineData(1)]
        public async void DeleteConfirmed_ActionExecutes_ReturnViewRedirectTo(int productId)
        {
