...
namespace RealWorldUnitTest.Test
{
    public class ProductControllerTestWithSqlServerLocalDb : ProductControllerTest
    {
        ...
        {
            var conStr = @"Data Source=localhost;Initial Catalog=UnitTestDB;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
            SetContextOptions(new DbContextOptionsBuilder<UnitTestDBContext>().UseSqlServer(conStr).Options);
        }
